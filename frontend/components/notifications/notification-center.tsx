...
export function NotificationCenter({ onNotificationClick }: NotificationCenterProps) {
  ...
  return (
    <DropdownMenu open={open} onOpenChange={(v) => { setOpen(v); if (v) { loadNotifications() } }}>
                ...
                >
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {notification.type === 'team_invite' && notification.data?.token && (
                        <div className="mt-2 flex items-center gap-2">
                          <Button
                            ...
                            onClick={async (e) => {
                              e.stopPropagation()
                              try {
                                const token = (notification as any)?.data?.token as string
                                if (!token) throw new Error('Thiếu token lời mời')
