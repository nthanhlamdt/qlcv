...
type RegisterFormProps = { isLoading?: boolean }

export default function RegisterForm({ isLoading }: RegisterFormProps) {
    ...
    <div className="w-full max-w-md mx-auto">
      <Card className="backdrop-blur supports-[backdrop-filter]:bg-background/80">
        <CardHeader>
          ...
          <CardDescription>Tạo tài khoản để bắt đầu sử dụng TaskFlow</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4" noValidate>
              ...
              <Button type="submit" className="w-full" disabled={disabled}>
                {disabled ? "Đang xử lý..." : "Tạo tài khoản"}
              </Button>
